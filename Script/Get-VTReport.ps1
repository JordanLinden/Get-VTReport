...
$Banner = "`nGet-VTReport v1.0 - Generate file signatures and submit to VirusTotal for detection reports"
...
Write-Host "`nDone! Results can be found in $reportFile under the Reports folder`n" -ForegroundColor Green